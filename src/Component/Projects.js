...
export default function Projects() {
  const project = [
    ...
    { projectNo: "Project 4", projectTitle: "Music Player", sumarry: "Developed a music player web application sing HTML, CSS, and JavaScript. Implemented features such as audio playback, playlists, and searching for songs. tilized JavaScript for the dynamic manipulation of the DOM to create a seamless user interface. Incorporated esponsive design using CSS to ensure optimal user experience on various screen sizes. Incorporated functionality to control playback, such as play, pause, and skip buttons, as well as the ability to adjust volume. Additionally, implemented drag-and-drop functionality for adding songs to playlists. Successfully deployed the application on a web server", link: "https://github.com/rkcoder093/Web-Music-Player" },
